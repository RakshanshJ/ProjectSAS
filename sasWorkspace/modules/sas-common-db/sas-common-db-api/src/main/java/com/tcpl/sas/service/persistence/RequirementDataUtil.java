...
/**
 * The persistence utility for the requirement data service. This utility wraps <code>com.tcpl.sas.service.persistence.impl.RequirementDataPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author Rakshansh
 * @see RequirementDataPersistence
 * @generated
 */
@ProviderType
public class RequirementDataUtil {
	 ...
	 */
	public static void clearCache(RequirementData requirementData) {
		getPersistence().clearCache(requirementData);
	}
	 ...
	 */
	public static Map<Serializable, RequirementData> fetchByPrimaryKeys(
	 ...
	 */
	public static List<RequirementData> findWithDynamicQuery(
	 ...
	 */
	public static RequirementData update(RequirementData requirementData) {
		return getPersistence().update(requirementData);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static RequirementData update(
		RequirementData requirementData, ServiceContext serviceContext) {

		return getPersistence().update(requirementData, serviceContext);
	}
	 ...
	 */
	public static List<RequirementData> findByUuid(String uuid) {
	 ...
	 */
	public static List<RequirementData> findByUuid(
	 ...
	 */
	public static RequirementData findByUuid_First(
			String uuid, OrderByComparator<RequirementData> orderByComparator)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {
	 ...
	 */
	public static RequirementData fetchByUuid_First(
		String uuid, OrderByComparator<RequirementData> orderByComparator) {
	 ...
	 * @throws NoSuchRequirementDataException if a matching requirement data could not be found
	 */
	public static RequirementData findByUuid_Last(
			String uuid, OrderByComparator<RequirementData> orderByComparator)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {
	 ...
	 */
	public static RequirementData fetchByUuid_Last(
		String uuid, OrderByComparator<RequirementData> orderByComparator) {
	 ...
	 */
	public static RequirementData[] findByUuid_PrevAndNext(
			long requirementDataId, String uuid,
			OrderByComparator<RequirementData> orderByComparator)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {

		return getPersistence().findByUuid_PrevAndNext(
			requirementDataId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchRequirementDataException if a matching requirement data could not be found
	 */
	public static RequirementData findByUUID_G(String uuid, long groupId)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {
	 ...
	 */
	public static RequirementData fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching requirement data, or <code>null</code> if a matching requirement data could not be found
	 */
	public static RequirementData fetchByUUID_G(
	 ...
	 */
	public static RequirementData removeByUUID_G(String uuid, long groupId)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {
	 ...
	 * @return the matching requirement datas
	 */
	public static List<RequirementData> findByFindByReqId(
		long requirementDataId) {

		return getPersistence().findByFindByReqId(requirementDataId);
	}
	...
	public static List<RequirementData> findByFindByReqId(
		...
		return getPersistence().findByFindByReqId(
			requirementDataId, start, end);
	}
	 ...
	 * @throws NoSuchRequirementDataException if a matching requirement data could not be found
	 */
	public static RequirementData findByFindByReqId_First(
			long requirementDataId,
			OrderByComparator<RequirementData> orderByComparator)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {

		return getPersistence().findByFindByReqId_First(
	 ...
	 * @return the first matching requirement data, or <code>null</code> if a matching requirement data could not be found
	 */
	public static RequirementData fetchByFindByReqId_First(
		long requirementDataId,
		OrderByComparator<RequirementData> orderByComparator) {

		return getPersistence().fetchByFindByReqId_First(
			requirementDataId, orderByComparator);
	}
	 ...
	 * @throws NoSuchRequirementDataException if a matching requirement data could not be found
	 */
	public static RequirementData findByFindByReqId_Last(
			long requirementDataId,
			OrderByComparator<RequirementData> orderByComparator)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {

		return getPersistence().findByFindByReqId_Last(
			requirementDataId, orderByComparator);
	}
	 ...
	 * @return the last matching requirement data, or <code>null</code> if a matching requirement data could not be found
	 */
	public static RequirementData fetchByFindByReqId_Last(
		long requirementDataId,
		OrderByComparator<RequirementData> orderByComparator) {

		return getPersistence().fetchByFindByReqId_Last(
			requirementDataId, orderByComparator);
	}
	 ...
	 * @param requirementDataId the requirement data ID
	 */
	public static void removeByFindByReqId(long requirementDataId) {
		getPersistence().removeByFindByReqId(requirementDataId);
	}
	 ...
	 * @return the number of matching requirement datas
	 */
	public static int countByFindByReqId(long requirementDataId) {
		return getPersistence().countByFindByReqId(requirementDataId);
	}
	 ...
	 * @throws NoSuchRequirementDataException if a matching requirement data could not be found
	 */
	public static RequirementData findByStatus(String status)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {
	 ...
	 * @return the matching requirement data, or <code>null</code> if a matching requirement data could not be found
	 */
	public static RequirementData fetchByStatus(String status) {
	 ...
	 * @return the matching requirement data, or <code>null</code> if a matching requirement data could not be found
	 */
	public static RequirementData fetchByStatus(
	 ...
	 * @return the requirement data that was removed
	 */
	public static RequirementData removeByStatus(String status)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {
	 ...
	 */
	public static void cacheResult(RequirementData requirementData) {
		getPersistence().cacheResult(requirementData);
	}
	 ...
	 */
	public static void cacheResult(List<RequirementData> requirementDatas) {
		getPersistence().cacheResult(requirementDatas);
	}
	 ...
	 */
	public static RequirementData create(long requirementDataId) {
		return getPersistence().create(requirementDataId);
	}
	 ...
	 * @throws NoSuchRequirementDataException if a requirement data with the primary key could not be found
	 */
	public static RequirementData remove(long requirementDataId)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {

		return getPersistence().remove(requirementDataId);
	}

	public static RequirementData updateImpl(RequirementData requirementData) {
		return getPersistence().updateImpl(requirementData);
	}
	 ...
	 * @throws NoSuchRequirementDataException if a requirement data with the primary key could not be found
	 */
	public static RequirementData findByPrimaryKey(long requirementDataId)
		throws com.tcpl.sas.exception.NoSuchRequirementDataException {

		return getPersistence().findByPrimaryKey(requirementDataId);
	}
	 ...
	 */
	public static RequirementData fetchByPrimaryKey(long requirementDataId) {
		return getPersistence().fetchByPrimaryKey(requirementDataId);
	}
	 ...
	 */
	public static List<RequirementData> findAll() {
	 ...
	 */
	public static List<RequirementData> findAll(int start, int end) {
	...
	public static RequirementDataPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<RequirementDataPersistence, RequirementDataPersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RequirementDataPersistence.class);

		ServiceTracker<RequirementDataPersistence, RequirementDataPersistence>
			serviceTracker =
				new ServiceTracker
					<RequirementDataPersistence, RequirementDataPersistence>(
						bundle.getBundleContext(),
						RequirementDataPersistence.class, null);
