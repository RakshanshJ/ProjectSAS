...
/**
 * Provides the local service interface for RequirementData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Rakshansh
 * @see RequirementDataLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RequirementDataLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RequirementDataLocalServiceUtil} to access the requirement data local service. Add custom service methods to <code>com.tcpl.sas.service.impl.RequirementDataLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
