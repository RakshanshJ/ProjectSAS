...
/**
 * Provides the local service interface for SourceVendor. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Rakshansh
 * @see SourceVendorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SourceVendorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SourceVendorLocalServiceUtil} to access the source vendor local service. Add custom service methods to <code>com.tcpl.sas.service.impl.SourceVendorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
